...
class Config(object):
    ...
    DATABASE_URL = os.environ.get("DATABASE_URL", "mongodb+srv://tojose6559:tojose6559@cluster0.6uxumbh.mongodb.net/?retryWrites=true&w=majority ")
    ...
    BOT_USERNAME = os.environ.get("BOT_USERNAME", "TiwivBot")
